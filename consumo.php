...
<div class="container login ">
    <div class="row">
        <div class="col-md-5">
            ...
            <form action="process.php" method="post" class="formConsumo">
            <h2><?= $returnCar["modelo"] ?></h2>
            ...
            <h4>Valor total gasto com esse carro:</h4> <br> <h1> R$ <?=formatMoney( $showTotal['0']) ?></h1>
        </div>
        <div class="col-md-7">
            <h3>Consumos</h3>
            ...
            <table id="tbConsumo">
                <tr>
                    <td><h5>Combust.:</h5></td>
                    <td><h5>Vlr pago:</h5></td>
                    <td><h5>Vlr/litro:</h5></td>
                    <td><h5>Km. painel:</h5></td>
                    <td class="dateFuel"><h5>Data:</h5></td>                
                 </tr>
                ...
                <?php foreach ($showConsum as $show): ?>
                    ...
                    <?php if ($show['car_id'] == $carId): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5>
                                        R$ <?= formatMoney( $show['vlrPay']) ?>
                                    </h5>
                                </td>
                                <td>
                                    <h5>
                                       R$ <?= formatMoney($show['vlrPump'] )?>
                                    </h5>
                                </td>
                                <td>
                                    <h5>
